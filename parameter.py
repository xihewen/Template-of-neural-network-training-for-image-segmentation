...
train_ct_path = r'E:\Data\liver\LITS17\liver\ct'  # 原始训练集CT数据路径

train_seg_path = r'E:\Data\liver\LITS17\liver\seg'  # 原始训练集标注数据路径
...
training_set_path = r'./data_prepare/train_noexpand'  # 用来训练网络的数据保存地址
